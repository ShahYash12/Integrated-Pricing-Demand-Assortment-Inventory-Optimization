...
**Pricing • Assortment  • Demmand • Inventory Planning**
...
This project demonstrates that **integrated, data-driven optimization** of pricing, assortment, and inventory decisions—grounded in realistic customer behavior and seasonality—dramatically outperforms traditional retail heuristics and provides a scalable framework for real-world decision support.# Integrated-Pricing-Demand-Assortment-Inventory-Optimization
